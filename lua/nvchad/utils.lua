...
M.list_themes = function()
  ...
  local custom_themes = vim.loop.fs_stat(fn.stdpath "config" .. "/lua/user/themes")

  if custom_themes and custom_themes.type == "directory" then
    local themes_tb = fn.readdir(fn.stdpath "config" .. "/lua/user/themes")
...
M.replace_word = function(old, new)
  local chadrc = vim.fn.stdpath "config" .. "/lua/user/" .. "chadrc.lua"
